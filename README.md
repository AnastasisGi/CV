...
| **Bank Tech Test** |Ruby , Rspec| A program that will allow a user to interact with a simple bank account (create account, deposit/withdraw money and get a statement) | https://github.com/AnastasisGi/Bank_tech_TDD_rb |
